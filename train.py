...
def parse_args():
    ...
    parser.add_argument("-w_i", "--weight_init", type=str, choices=["random", "Xavier", "kaiming"], default="Xavier", help="Weight initialization method")
    ...
    parser.add_argument("-a", "--activation", type=str, choices=["sigmoid", "tanh", "ReLU"], required=False, default="tanh")
